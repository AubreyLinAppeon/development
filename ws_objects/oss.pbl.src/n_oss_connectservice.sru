$PBExportHeader$n_oss_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_oss_connectservice from nonvisualobject
end type
end forward

global type n_oss_connectservice from nonvisualobject
end type
global n_oss_connectservice n_oss_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		...
		as_logpass		= ProfileString ( ls_inifile, "Database", "LogPassword",	"dba")
		as_server		= ProfileString ( ls_inifile, "Database", "Servername", "localhost")
		as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm", "Database='PB License Release History'")
	...
	Case IS_USE_REGISTRY						/*  Populate Database Connection from Registry  */
		...
		If RegistryGet ( ls_registrykey, "LogPassword", RegString!, as_logpass ) <> 1 Then
			RegistrySet ( ls_registrykey, "LogPassword", RegString!, "dba" )
		...
		If RegistryGet ( ls_registrykey, "DBParm", 		RegString!, as_dbparm ) <> 1 Then
			RegistrySet ( ls_registrykey, "DBParm", 		RegString!, "Database='PB License Release History'" )
	...
	Case IS_USE_SCRIPT							/*  Populate Database Connection from Script  */
		...
		as_logid			= "sa"
		as_logpass		= "dba"
		as_server		= "192.168.128.52"
		as_dbparm		= "Database='PB License Release History'"
		as_lock			= ""
		as_autocommit	= "false"
...
on n_oss_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_oss_connectservice.destroy
